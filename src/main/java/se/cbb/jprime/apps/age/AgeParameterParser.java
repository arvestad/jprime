...
import se.cbb.jprime.apps.age.DLRModel;
import se.cbb.jprime.apps.age.DupLossProbs;
import se.cbb.jprime.apps.ParameterParser;
import se.cbb.jprime.apps.age.RealisationSampler;
import se.cbb.jprime.apps.age.ReconciliationHelper;
...
public class AgeParameterParser extends ParameterParser {
	...
	public static ReconciliationHelper getReconciliationHelper(
			AgeParameters ps, RBTree g, RBTree s, RBTreeArcDiscretiser dtimes,
			MPRMap mprMap) {
	 ...
	 * @throws IOException.
	 */
	public static RealisationSampler getRealisationSampler(AgeParameters ps, Iteration iter, PRNG prng, DLRModel model, NamesMap names) throws IOException {
	 ...
	 */
	public static Triple<DoubleParameter, DoubleParameter, DupLossProbs> getDupLossProbs(AgeParameters ps, MPRMap mpr, RBTree s, RBTree g, RBTreeArcDiscretiser times) {
